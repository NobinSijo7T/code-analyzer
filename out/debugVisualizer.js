...
class DebugVisualizer {
    ...
    createDebugPanel() {
        this.debugPanel = vscode.window.createWebviewPanel('debugVisualization', 'Debug Visualization', vscode.ViewColumn.Two, {
            enableScripts: true,
    ...
    handleDebugSessionStart(_session) {
        if (!this.debugPanel) {
            this.createDebugPanel();
        }
        this.updateDebugView();
    }
    handleDebugSessionEnd(_session) {
        if (this.debugPanel) {
            this.debugPanel.dispose();
        }
    }
    handleBreakpointChange(_event) {
        this.updateDebugView();
    }
